...
VIBES_SALES_TEXT = (
    ...
    "<b>с нуля до работающего продукта</b>. Без кода, без программиста.\n\n"
    ...
    "Всего <b>20 мест</b>, 5 уже занято."
)
...
async def send_live_stream_link(chat_id: int, delay_seconds: int = 60) -> None:
    ...
    message = (
        ...
        "<i>в реальном времени</i> - заглядывай на мой <b>прямой эфир</b>.\n\n"
...
async def cmd_start(message: types.Message, state: FSMContext) -> None:
    ...
    welcome_message = (
        "Привет! 👋 Я - <b>AI-генератор идей</b> для вайб-кодинга.\n\n"
        "Подберу тебе <b>3-5 проектов</b>, которые ты сможешь создать сам, "
        "без программиста - за пару вечеров 🛠\n\n"
        "✏️ Напиши свою нишу или чем занимаешься - и я подберу идеи под тебя."
    )
